    ...
    <div className="w-75 col-sm-12">
      ...
      <form className="my-3" onSubmit={formRegister.handleSubmit}>
        ...
        {formRegister.errors.email && formRegister.touched.email ? (
          <div className="text-danger">{formRegister.errors.email}</div>
        ) : (
          ""
        )}
        ...
        {formRegister.errors.password && formRegister.touched.password ? (
          <div className="text-danger">{formRegister.errors.password}</div>
        ) : (
          ""
        )}
        <div className="mt-2 col-md-12 row g-2">
          <Link to="/forgetpassword" className="mx-3 col-md-3 ">
            Forget Password
          </Link>
          <Link to="/register" className="col-md-6 col-sm-12 ">
        ...
        {loading ? (
          ...
          <i className="fas fa-spinner fa-spin bg-main"></i>
        )}
      </form>
    </div>
  );
